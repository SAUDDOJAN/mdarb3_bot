  ...
  async execute(oldState, newState, client) {
    ...
    try {
      ...
      if (joinedNew) {
        ...
        await handleVoiceLeave(client, member, oldState.channel);
        await handleLfgVoiceLeave(client, member, oldState.channel);
        await checkLfgChannelCleanup(client, oldState.channelId, cleanUpEmptyLfg);
